...
export default function NewHome(){
    ...
    const [graph, setGraph] = React.useState({month: "02", year: 2023, name: "February"})
                ...
                <div className="flex toColumn mTop20">
                    <div className={`w60 app-content mRight40 wm100 mRnone mmTop20 ${styles.graphic}`}>
                        ...
                        <div className="mTop20 mmTop10">
                            ...
                            <Chip onClick={() => callGraph('12', '2022', 'December')} sx={{ marginRight: '10px', border: '0px', boxShadow: '1px 1px 25px rgba(0,0,0,0.07)', fontWeight: '600', padding: '10px 10px' }} variant="outlined" label="December 2022" />
