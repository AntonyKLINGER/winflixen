                ...
                <div className="flex toColumn flex-start">
                    <div className="w65 relative mRight30 mRnone wm100">
                        ...
                        <h2 className="app-title-h2">The first real-time automated soccer bot! </h2>
                             ...
                             <p> As a bettor, you should know that pre-match ratings and live match ratings are no longer the same. When a game starts, the ratings fluctuate much faster, which allows for value bets in certain <strong>*</strong> periods of the game and depending on the events. The more an event arrives at the beginning of the game, the more often the bot will query all the parameters of the games to give you <Link href="/fussball/predict/">football predictions</Link> to within seconds / minutes after the to play alert. </p>
